...
def run_N2NMatcher_evaluation(cmd):
    ...
    results_folder = r"/data1/jiaang/binkit2/9.apply_classifier_to_fcg_nodes/x86_64_clang/evaluate_results"
    ...
    for index1 in range(0, len(fcg_path_list)):
        for index2 in range(0, len(fcg_path_list)):
            ...
            if not is_same_compiler_diff_opt(os.path.basename(fcg_file1).replace(".i64.fcg.fcg_pkl", ""),
...
def main():
    results_folder = r"/data1/jiaang/binkit2/9.apply_classifier_to_fcg_nodes/x86_64_clang/results/"
