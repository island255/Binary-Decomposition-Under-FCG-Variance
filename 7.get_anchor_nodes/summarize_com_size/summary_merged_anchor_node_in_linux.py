...
def summarize_community_statistics(inlining_communities_1):
    com1_statistics = []
    for com in inlining_communities_1:
        com1_statistics.append(len(com))
    return com1_statistics
...
def run_anchor_node_generation(cmd):
    ...
    for index1 in range(0, len(binary_to_fcg_files)):
        for index2 in range(0, len(binary_to_fcg_files)):
            ...
            com1_statistics = summarize_community_statistics(inlining_communities_1)
            com2_statistics = summarize_community_statistics(inlining_communities_2)
            anchor_info = {"com1": com1_statistics, "com2": com2_statistics}
...
def get_anchor_node_in_linux():
    ...
    anchor_folder = r"/data1/jiaang/binkit2/7.anchor_node_identification/summary_anchor_community"
