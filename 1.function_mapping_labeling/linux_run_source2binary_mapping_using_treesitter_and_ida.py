...
def main():
    binary_projects_dir = "/data1/jiaang/binkit2/Dataset"
    ...
    source_project_folder = "/data1/jiaang/binkit2/Dataset/src"
    binary_project_folder = "/data1/jiaang/binkit2/0.preprocessing/Binaries/Dataset-1"

    flowchart_dir = "/data1/jiaang/binkit2/0.preprocessing/IDA_scripts/IDA_flowchart/flowchart_csv_dataset_I"
